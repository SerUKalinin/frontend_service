...
import ResponsibleUserModal from './ResponsibleUserModal';
...
const ResponsibleUserManager: React.FC<ResponsibleUserManagerProps> = ({
  ...
  const handleRemove = async () => {
    try {
      await api.put(`/real-estate-objects/${objectId}/remove-responsible`);
      onChange();
    } catch (err) {
...
export default ResponsibleUserManager; 